...
def test_machine_tier_precedence_and_count(page):
    ...
    # + the multi-snapshot re-verification (2026-07-05, recovered Lu):
    # elements-machine.json now holds 52 elements, but Cu and Nb also carry
    # curated records and resolve 'curated' by precedence -> 50 tally as
    # machine.
    assert r["tally"]["machine"] == 50
